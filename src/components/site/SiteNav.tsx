    ...
    >
      ...
      >
        ...
        <Link
          ...
          {...cta.handlers}
          style={cta.style}
          className="rounded-md border border-border-strong px-4 py-2 text-sm text-foreground transition-colors duration-200 ease-out hover:border-primary hover:text-primary"
        >
          Book a Consultation
        </Link>
      </nav>
